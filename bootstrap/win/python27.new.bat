...
set /p WIN_TOOLS_RELDIR=<%~dp0win_tools_reldir.txt
set PATH=%~dp0%WIN_TOOLS_RELDIR%\python\bin;%~dp0%WIN_TOOLS_RELDIR%\python\bin\Scripts;%PATH%
"%~dp0%WIN_TOOLS_RELDIR%\python\bin\python.exe" %*
