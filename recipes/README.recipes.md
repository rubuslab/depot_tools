...
&mdash; **def [deapply\_patch](/recipes/recipe_modules/bot_update/api.py#585)(self, bot_update_step):**
...
&mdash; **def [get\_project\_revision\_properties](/recipes/recipe_modules/bot_update/api.py#562)(self, project_name, gclient_config=None):**
...
&mdash; **def [resolve\_fixed\_revision](/recipes/recipe_modules/bot_update/api.py#513)(self, bot_update_json, name):**
...
<<<<<<< PATCH SET (23ce77 Upload git traces from bot_update)
...
>>>>>>> BASE      (defdda Roll recipe dependencies (trivial).)
