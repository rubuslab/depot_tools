...
&mdash; **def [get\_project\_revision\_properties](/recipes/recipe_modules/bot_update/api.py#560)(self, project_name, gclient_config=None):**
...
&mdash; **def [resolve\_fixed\_revision](/recipes/recipe_modules/bot_update/api.py#511)(self, bot_update_json, name):**
...
<<<<<<< PATCH SET (23a15e Upload git traces from bot_update)
...
>>>>>>> BASE      (19ea20 Roll recipe dependencies (trivial).)
