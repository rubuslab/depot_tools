...
class ProvidedDiffChangeTest(fake_repos.FakeReposTestBase):
    ...
    def test_old_contents_of_added_file_returns_empty(self):
        ...
        self.assertEqual(affected_file.NewContents(), ['a new file'])
    ...
    def test_old_contents_of_deleted_file_returns_whole_file(self):
        ...
        self.assertEqual(affected_file.NewContents(), [])
    ...
    def test_old_contents_of_modified_file(self):
        ...
        self.assertEqual(affected_file.NewContents(), ['changed me!'])

    def test_old_contents_of_file_with_nested_dirs(self):
        affected_file = self._get_affected_file_from_name(
            self.change, 'somewhere/else')
        self.assertEqual(affected_file.OldContents(), ['not a top level file!'])
        self.assertEqual(affected_file.NewContents(),
