...
def SwitchToIssue(options, issue_numbers):
  """Switch to the branch associated to issue issue_numbers[0]

  Fail if issue_numbers[0] is not a number.
  If no such branch exists and the issue exists on gerrit,
  create a new branch and switch to it.
  If there are multiple such branch, warns and behaves as
  `git cl issue -r issue_numbers[0]`.
  """
