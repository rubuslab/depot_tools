...
def checkout(options, git_slns, specs, revisions, step_text):
  ...
  cache_age = os.stat(os.path.realpath(options.git_cache_dir)).st_ctime
  print('git_cache age: {}'.format(datetime.fromtimestamp(cache_age)))
  ...
  properties['git_cache_age'] = cache_age
