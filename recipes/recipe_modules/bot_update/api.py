...
class BotUpdateApi(recipe_api.RecipeApi):
  ...
  def deapply_patch(self, bot_update_step):
    ...
    # TODO(crbug.com/1019824): Pass |fetch_checkout_tags=False| here to prevent
    # fetching 10k+ tags for chromium. This operation shouldn't need tags, it
    # is removing a previously applied patch.
