...
class GitConfigStateTestTest(unittest.TestCase):
    ...
    def test_set_config_global_append_empty(self):
        ...
        m.set_config('key', 'new_global', append=True, scope='global')
        self.assertDictEqual(m.load_config(), {
            'key': ['new_global'],
        })
...
class CanonicalizeGitConfigKeyTest(unittest.TestCase):
    ...
    def test_many(self):
        self.assertEqual(self.ck("URL.https://SoMeThInG.example.com.INSTEADOF"), "url.https://SoMeThInG.example.com.insteadof")
...
class CachedGitConfigStateTest(unittest.TestCase):
    ...
    def test_errors(self):
        ...
        with self.assertRaisesRegex(
            ...
            gcs.SetConfig('section.variable', 'value', value_pattern='hi',
                          modify_all=False)

        with self.assertRaisesRegex(
                ValueError, 'value_pattern.*append.*invalid'):
            gcs.SetConfig('section.variable', 'value', value_pattern='hi',
                          modify_all=True, append=True)
    ...
    def test_set_pattern(self):
        ...
        gcs.SetConfig('section.variable', 'poof', value_pattern='.*_bleem',
                      modify_all=True)
