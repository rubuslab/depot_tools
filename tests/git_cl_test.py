    ...
    expected_comments_summary = [
      git_cl._CommentSummary(
        message=(
            ...
            u'  Base, Line 42 (codereview.settings:42)\n' +
            u'  https://chromium-review.googlesource.com/c/1/2/' +
      ...
      git_cl._CommentSummary(
        message=(
            ...
            u'\n' +
            u'/COMMIT_MSG\n' +
            u'  PS2, File comment (/COMMIT_MSG)\n' +
            u'  https://chromium-review.googlesource.com/c/1/2//COMMIT_MSG#\n' +
