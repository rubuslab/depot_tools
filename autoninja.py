...
# If GOMA_DISABLED is set to "true", "t", "yes", "y", or "1" then gomacc will
# use the local compiler instead of doing a goma compile. This is convenient if
# you want to briefly disable goma. It avoids having to rebuild the world when
...
if os.environ.get('GOMA_DISABLED', '0') in ['true', 't', 'yes', 'y', '1']:
  use_goma = False
