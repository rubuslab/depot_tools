...
**[Recipes](#Recipes)**
  ...
  * [gerrit:tests/create_branch_allow_existent](#recipes-gerrit_tests_create_branch_allow_existent) (Python3 ✅)
  * [gerrit:tests/create_branch_with_exceptions](#recipes-gerrit_tests_create_branch_with_exceptions) (Python3 ✅)
...
#### **class [GerritApi](/recipes/recipe_modules/gerrit/api.py#8)([RecipeApi][recipe_engine/wkt/RecipeApi]):**
...
&mdash; **def [abandon\_change](/recipes/recipe_modules/gerrit/api.py#293)(self, host, change, message=None, name=None, step_test_data=None):**
...
&mdash; **def [create\_gerrit\_tag](/recipes/recipe_modules/gerrit/api.py#115)(self, host, project, tag, commit, \*\*kwargs):**
...
&mdash; **def [get\_change\_description](/recipes/recipe_modules/gerrit/api.py#154)(self, host, change, patchset, timeout=None, step_test_data=None):**
...
&mdash; **def [get\_changes](/recipes/recipe_modules/gerrit/api.py#214)(self, host, query_params, start=None, limit=None, o_params=None, step_test_data=None, \*\*kwargs):**
...
&mdash; **def [get\_gerrit\_branch](/recipes/recipe_modules/gerrit/api.py#136)(self, host, project, branch, \*\*kwargs):**
...
&mdash; **def [get\_related\_changes](/recipes/recipe_modules/gerrit/api.py#257)(self, host, change, revision='current', step_test_data=None):**
...
&mdash; **def [get\_revision\_info](/recipes/recipe_modules/gerrit/api.py#173)(self, host, change, patchset, timeout=None, step_test_data=None):**
...
&mdash; **def [move\_changes](/recipes/recipe_modules/gerrit/api.py#331)(self, host, project, from_branch, to_branch, step_test_data=None):**

&mdash; **def [set\_change\_label](/recipes/recipe_modules/gerrit/api.py#313)(self, host, change, label_name, label_value, name=None, step_test_data=None):**

&mdash; **def [update\_files](/recipes/recipe_modules/gerrit/api.py#355)(self, host, project, branch, new_contents_by_file_path, commit_msg, params=frozenset(['status=NEW']), cc_list=frozenset([]), submit=False, submit_later=False, step_test_data_create_change=None, step_test_data_submit_change=None):**
...
### *recipes* / [gerrit:tests/create\_branch\_allow\_existent](/recipes/recipe_modules/gerrit/tests/create_branch_allow_existent.py)

[DEPS](/recipes/recipe_modules/gerrit/tests/create_branch_allow_existent.py#7): [gerrit](#recipe_modules-gerrit), [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/step][recipe_engine/recipe_modules/step]

PYTHON_VERSION_COMPATIBILITY: PY3

&mdash; **def [RunSteps](/recipes/recipe_modules/gerrit/tests/create_branch_allow_existent.py#15)(api):**
### *recipes* / [gerrit:tests/create\_branch\_with\_exceptions](/recipes/recipe_modules/gerrit/tests/create_branch_with_exceptions.py)

[DEPS](/recipes/recipe_modules/gerrit/tests/create_branch_with_exceptions.py#7): [gerrit](#recipe_modules-gerrit), [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/step][recipe_engine/recipe_modules/step]

PYTHON_VERSION_COMPATIBILITY: PY3

&mdash; **def [RunSteps](/recipes/recipe_modules/gerrit/tests/create_branch_with_exceptions.py#15)(api):**
