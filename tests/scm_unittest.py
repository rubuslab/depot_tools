...
class GitConfigStateTestTest(unittest.TestCase):
    ...
    def _make(*,
        ...
        mock = scm.GitConfigStateTest(threading.Lock(),
                                      global_state,
                                      system_state=system_state,
                                      local_state=local_state,
                                      worktree_state=worktree_state)
        return mock, global_state
    ...
    def test_set_config_multi_global(self):
        ...
        m.set_config_multi('key', 'new_global', value_pattern=None, scope='global')
        self.assertDictEqual(m.load_config(), {
            'key': ['new_global'],
        })
        ...
        m.set_config_multi('other', 'newval', value_pattern=None, scope='global')
        self.assertDictEqual(m.load_config(), {
            'key': ['new_global'],
            'other': ['newval'],
        })
    ...
    def test_set_config_multi_global_pattern(self):
        ...
        m.set_config_multi('key', 'new_global', value_pattern='2', scope='global')
        self.assertDictEqual(m.load_config(), {
            'key': ['1', '1', 'new_global', '3'],
        })

        m.set_config_multi('key', 'additional', value_pattern='narp', scope='global')
        self.assertDictEqual(m.load_config(), {
    ...
    def test_unset_config_multi_global(self):
        ...
        m.unset_config_multi('key', value_pattern=None, scope='global', missing_ok=False)
        self.assertDictEqual(m.load_config(), {})
    ...
    def test_unset_config_multi_global_pattern(self):
        ...
        m.unset_config_multi('key', value_pattern='2', scope='global', missing_ok=False)
        self.assertDictEqual(m.load_config(), {
            'key': ['1', '3', '1'],
        })
