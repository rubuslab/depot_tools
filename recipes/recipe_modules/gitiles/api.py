...
class Gitiles(recipe_api.RecipeApi):
  ...
  def refs(self, url, step_name=None, default_test_data=None):
    ...
    Arguments:
      default_test_data (dict): Default step test data, if the test doesn't
          supply any explicitly. Should be formatted like test API's
          "make_refs_test_data".
    """
