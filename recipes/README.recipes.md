...
&mdash; **def [get\_project\_revision\_properties](/recipes/recipe_modules/bot_update/api.py#555)(self, project_name, gclient_config=None):**
...
&mdash; **def [resolve\_fixed\_revision](/recipes/recipe_modules/bot_update/api.py#506)(self, bot_update_json, name):**
...
<<<<<<< PATCH SET (1fbdb6 Upload git traces from bot_update)
...
>>>>>>> BASE      (a6123d [cipd] Update to 2.6.15.)
