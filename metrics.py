...
class MetricsCollector(object):
  ...
  def _upload_metrics_data(self):
    ...
    reported_metrics_file = tempfile.mkstemp()[1]
    gclient_utils.FileWrite(reported_metrics_file,
                            json.dumps(self._reported_metrics))
    subprocess.Popen(
        [sys.executable, UPLOAD_SCRIPT, reported_metrics_file],
