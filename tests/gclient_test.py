...
class GclientTest(trial_dir.TestCase):
  ...
  def testParseGitSubmodules_ParsesSubmodules(self):
    ...
    submodule_status = \
      """+be8c5114d606692dc783b60cf256690b62fbad17 foo/bar (heads/hello)
    -3ad3b564f8ae456f286446d091709f5a09fa4a93 aaaaaa (heads/hello)
    956df937508b65b5e72a4cf02696255be3631b78 a.a.a/a
    b9f77763f0fab67eeeb6371492166567a8b7a3d2 a_b/c (heads/hello)"""
    ...
    subprocess2_check_output_mock = mock.MagicMock(
        side_effect=[submodule_status.encode(),
                     git_config.encode()])
    # subprocess2_check_output_mock.side_effect = [submodule_status, git_config]
