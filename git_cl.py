    ...
    if options.squash:
      ...
      if self.GetIssue(): # the issue exists
        ...
        if curr_ps != latest_ps:
          ...
          print("WARNING: <some number of> External changes have been published <to the CL>.")
          confirm_or_exit(action='sync upstream changes')
          # gerrit_util.GetPatch(self._gerrit_host, change_id, )
