...
class GitMutableFunctionsTest(git_test_utils.GitRepoReadWriteTestBase,
  ...
  def testGetBranchesInfoWithReset(self):
    ...
    self.repo.git('config', 'branch.foobarA.base', self.repo.run(self.gc.hash_one, 'master'))
    ...
    self.repo.git('config', 'branch.foobarB.base', self.repo.run(self.gc.hash_one, 'foobarA'))
