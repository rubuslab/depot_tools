...
def git_checkouts(solutions, revisions, refs, no_bootstrap, no_fetch_tags, git_cache_dir,
                  cleanup_dir, enforce_fetch):
  build_dir = os.getcwd()
  first_solution = True
  for sln in solutions:
    sln_dir = path.join(build_dir, sln['name'])
    _git_checkout(sln, sln_dir, revisions, refs, no_bootstrap, no_fetch_tags, git_cache_dir,
                  cleanup_dir, enforce_fetch)
    if first_solution:
...
def _git_checkout(sln, sln_dir, revisions, refs, no_bootstrap, no_fetch_tags, git_cache_dir,
                  cleanup_dir, enforce_fetch):
  name = sln['name']
  url = sln['url']
