...
&emsp; **@property**<br>&mdash; **def [DepsDiffException](/recipes/recipe_modules/gclient/api.py#439)(self):**

&mdash; **def [\_\_call\_\_](/recipes/recipe_modules/gclient/api.py#86)(self, name, cmd, infra_step=True, \*\*kwargs):**

Wrapper for easy calling of gclient steps.

&mdash; **def [break\_locks](/recipes/recipe_modules/gclient/api.py#290)(self):**

Remove all index.lock files. If a previous run of git crashed, bot was
reset, etc... we might end up with leftover index.lock files.

&mdash; **def [checkout](/recipes/recipe_modules/gclient/api.py#250)(self, gclient_config=None, revert=RevertOnTryserver, inject_parent_got_revision=True, extra_sync_flags=None, \*\*kwargs):**

Return a step generator function for gclient checkouts.

&emsp; **@staticmethod**<br>&mdash; **def [config\_to\_pythonish](/recipes/recipe_modules/gclient/api.py#138)(cfg):**

&mdash; **def [diff\_deps](/recipes/recipe_modules/gclient/api.py#382)(self, cwd):**

&mdash; **def [get\_config\_defaults](/recipes/recipe_modules/gclient/api.py#132)(self):**

&mdash; **def [get\_gerrit\_patch\_root](/recipes/recipe_modules/gclient/api.py#313)(self, gclient_config=None):**
...
&mdash; **def [get\_repo\_path](/recipes/recipe_modules/gclient/api.py#340)(self, repo_url, gclient_config=None):**
...
&emsp; **@staticmethod**<br>&mdash; **def [got\_revision\_reverse\_mapping](/recipes/recipe_modules/gclient/api.py#143)(cfg):**
...
&mdash; **def [inject\_parent\_got\_revision](/recipes/recipe_modules/gclient/api.py#225)(self, gclient_config=None, override=False):**
...
&mdash; **def [resolve\_revision](/recipes/recipe_modules/gclient/api.py#160)(self, revision):**

&mdash; **def [runhooks](/recipes/recipe_modules/gclient/api.py#284)(self, args=None, name='runhooks', \*\*kwargs):**

&mdash; **def [set\_patch\_repo\_revision](/recipes/recipe_modules/gclient/api.py#370)(self, gclient_config=None):**
...
&emsp; **@spec_alias.deleter**<br>&mdash; **def [spec\_alias](/recipes/recipe_modules/gclient/api.py#128)(self):**

&mdash; **def [sync](/recipes/recipe_modules/gclient/api.py#165)(self, cfg, extra_sync_flags=None, \*\*kwargs):**

&emsp; **@use_mirror.setter**<br>&mdash; **def [use\_mirror](/recipes/recipe_modules/gclient/api.py#115)(self, val):**
