...
#### **class [OSXSDKApi](/recipes/recipe_modules/osx_sdk/api.py#42)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

API for using OS X SDK distributed via CIPD.

&emsp; **@contextmanager**<br>&mdash; **def [\_\_call\_\_](/recipes/recipe_modules/osx_sdk/api.py#60)(self, kind):**
...
&mdash; **def [initialize](/recipes/recipe_modules/osx_sdk/api.py#53)(self):**
