...
def GetBuildTargets(cmdline):
    ...
    >>> GetBuildTargets(['ninja', 'chrome'])
    ['chrome']
    >>> GetBuildTargets(['ninja', '-j', '1000', 'chrome'])
    ['chrome']
    >>> GetBuildTargets(['ninja', 'chrome', '-j', '1000'])
    ['chrome']
    >>> GetBuildTargets(['ninja', '-C', 'chrome'])
    []
    >>> GetBuildTargets(['ninja', '-Cout/Relese', 'chrome'])
    ['chrome']
    """
