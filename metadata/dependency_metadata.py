...
class DependencyMetadata:
    ...
    def validate(self, source_file_dir: str,
        ...
        # Version, Date or Revision must be provided (or the revision is
        # managed by DEPS file).
    ...
    def revision_in_deps(self) -> bool:
        """Returns whether the revision is managed by DEPS file."""
        value = self._metadata.get(known_fields.REVISION, "")
        return known_fields.REVISION.is_in_deps(value)
