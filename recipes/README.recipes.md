...
&mdash; **def [add\_failure\_reason](/recipes/recipe_modules/tryserver/api.py#211)(self, reason):**
...
&emsp; **@property**<br>&mdash; **def [gerrit\_change\_dest\_ref](/recipes/recipe_modules/tryserver/api.py#111)(self):**

Returns gerrit change destination ref, e.g. "refs/heads/master".

Populated iff gerrit_change is populated.

&emsp; **@property**<br>&mdash; **def [gerrit\_change\_patch\_ref](/recipes/recipe_modules/tryserver/api.py#102)(self):**
...
&mdash; **def [get\_files\_affected\_by\_patch](/recipes/recipe_modules/tryserver/api.py#141)(self, patch_root, \*\*kwargs):**
...
&mdash; **def [get\_footer](/recipes/recipe_modules/tryserver/api.py#266)(self, tag, patch_text=None):**

Gets a specific tag from a CL description

&mdash; **def [get\_footers](/recipes/recipe_modules/tryserver/api.py#247)(self, patch_text=None):**
...
&emsp; **@property**<br>&mdash; **def [is\_gerrit\_issue](/recipes/recipe_modules/tryserver/api.py#125)(self):**

Returns true iff the properties exist to match a Gerrit issue.

&emsp; **@property**<br>&mdash; **def [is\_patch\_in\_git](/recipes/recipe_modules/tryserver/api.py#135)(self):**

&emsp; **@property**<br>&mdash; **def [is\_tryserver](/recipes/recipe_modules/tryserver/api.py#120)(self):**

Returns true iff we have a change to check out.

&mdash; **def [normalize\_footer\_name](/recipes/recipe_modules/tryserver/api.py#270)(self, footer):**

&mdash; **def [set\_compile\_failure\_tryjob\_result](/recipes/recipe_modules/tryserver/api.py#190)(self):**

Mark the tryjob result as a compile failure.

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [set\_failure\_hash](/recipes/recipe_modules/tryserver/api.py#220)(self):**
...
&mdash; **def [set\_invalid\_test\_results\_tryjob\_result](/recipes/recipe_modules/tryserver/api.py#202)(self):**
...
&mdash; **def [set\_patch\_failure\_tryjob\_result](/recipes/recipe_modules/tryserver/api.py#186)(self):**

Mark the tryjob result as failure to apply the patch.

&mdash; **def [set\_subproject\_tag](/recipes/recipe_modules/tryserver/api.py#168)(self, subproject_tag):**
...
&mdash; **def [set\_test\_failure\_tryjob\_result](/recipes/recipe_modules/tryserver/api.py#194)(self):**
