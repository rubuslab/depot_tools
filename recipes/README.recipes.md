...
&mdash; **def [abandon\_change](/recipes/recipe_modules/gerrit/api.py#287)(self, host, change, message=None, name=None, step_test_data=None):**
...
&mdash; **def [create\_gerrit\_tag](/recipes/recipe_modules/gerrit/api.py#109)(self, host, project, tag, commit, \*\*kwargs):**
...
&mdash; **def [get\_change\_description](/recipes/recipe_modules/gerrit/api.py#148)(self, host, change, patchset, timeout=None, step_test_data=None):**
...
&mdash; **def [get\_changes](/recipes/recipe_modules/gerrit/api.py#208)(self, host, query_params, start=None, limit=None, o_params=None, step_test_data=None, \*\*kwargs):**
...
&mdash; **def [get\_gerrit\_branch](/recipes/recipe_modules/gerrit/api.py#130)(self, host, project, branch, \*\*kwargs):**
...
&mdash; **def [get\_related\_changes](/recipes/recipe_modules/gerrit/api.py#251)(self, host, change, revision='current', step_test_data=None):**
...
&mdash; **def [get\_revision\_info](/recipes/recipe_modules/gerrit/api.py#167)(self, host, change, patchset, timeout=None, step_test_data=None):**
...
&mdash; **def [move\_changes](/recipes/recipe_modules/gerrit/api.py#325)(self, host, project, from_branch, to_branch, step_test_data=None):**

&mdash; **def [set\_change\_label](/recipes/recipe_modules/gerrit/api.py#307)(self, host, change, label_name, label_value, name=None, step_test_data=None):**

&mdash; **def [update\_files](/recipes/recipe_modules/gerrit/api.py#349)(self, host, project, branch, new_contents_by_file_path, commit_msg, params=frozenset(['status=NEW']), cc_list=frozenset([]), submit=False, submit_later=False, step_test_data_create_change=None, step_test_data_submit_change=None):**
