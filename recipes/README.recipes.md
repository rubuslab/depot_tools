...
&mdash; **def [abandon\_change](/recipes/recipe_modules/gerrit/api.py#274)(self, host, change, message=None, name=None, step_test_data=None):**

&mdash; **def [change\_edit](/recipes/recipe_modules/gerrit/api.py#32)(self, host, change, path, file, \*\*kwargs):**

Puts content of a file into a change edit.

&mdash; **def [create\_change](/recipes/recipe_modules/gerrit/api.py#61)(self, host, project, branch, commit_msg, \*\*kwargs):**
...
&mdash; **def [create\_gerrit\_branch](/recipes/recipe_modules/gerrit/api.py#97)(self, host, project, branch, commit, \*\*kwargs):**
...
&mdash; **def [get\_change\_description](/recipes/recipe_modules/gerrit/api.py#136)(self, host, change, patchset, timeout=None, step_test_data=None):**
...
&mdash; **def [get\_changes](/recipes/recipe_modules/gerrit/api.py#196)(self, host, query_params, start=None, limit=None, o_params=None, step_test_data=None, \*\*kwargs):**
...
&mdash; **def [get\_gerrit\_branch](/recipes/recipe_modules/gerrit/api.py#118)(self, host, project, branch, \*\*kwargs):**
...
&mdash; **def [get\_related\_changes](/recipes/recipe_modules/gerrit/api.py#238)(self, host, change, revision='current', step_test_data=None):**
...
&mdash; **def [get\_revision\_info](/recipes/recipe_modules/gerrit/api.py#155)(self, host, change, patchset, timeout=None, step_test_data=None):**
...
&mdash; **def [publish\_edit](/recipes/recipe_modules/gerrit/api.py#49)(self, host, change, \*\*kwargs):**

Publish a Gerrit change edit.

&mdash; **def [submit\_change](/recipes/recipe_modules/gerrit/api.py#84)(self, host, change, \*\*kwargs):**
