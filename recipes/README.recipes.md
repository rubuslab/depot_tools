...
&mdash; **def [break\_locks](/recipes/recipe_modules/gclient/api.py#289)(self):**

Remove all index.lock files. If a previous run of git crashed, bot was
reset, etc... we might end up with leftover index.lock files.

&mdash; **def [calculate\_patch\_root](/recipes/recipe_modules/gclient/api.py#311)(self, patch_project, gclient_config=None):**
...
&mdash; **def [checkout](/recipes/recipe_modules/gclient/api.py#235)(self, gclient_config=None, revert=RevertOnTryserver, inject_parent_got_revision=True, with_branch_heads=False, \*\*kwargs):**
...
&emsp; **@property**<br>&mdash; **def [is\_blink\_mode](/recipes/recipe_modules/gclient/api.py#276)(self):**
...
&mdash; **def [set\_patch\_project\_revision](/recipes/recipe_modules/gclient/api.py#338)(self, patch_project, gclient_config=None):**
...
&mdash; **def [sync](/recipes/recipe_modules/gclient/api.py#152)(self, cfg, with_branch_heads=True, \*\*kwargs):**
