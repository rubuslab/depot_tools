...
&mdash; **def [commit\_log](/recipes/recipe_modules/gitiles/api.py#105)(self, url, commit, step_name=None, attempts=None):**
...
&mdash; **def [download\_archive](/recipes/recipe_modules/gitiles/api.py#147)(self, repository_url, destination, revision='refs/heads/master'):**

&mdash; **def [download\_file](/recipes/recipe_modules/gitiles/api.py#121)(self, repository_url, file_path, branch='master', step_name=None, attempts=None, \*\*kwargs):**
...
&mdash; **def [log](/recipes/recipe_modules/gitiles/api.py#59)(self, url, ref, limit=0, cursor=None, step_name=None, attempts=None, \*\*kwargs):**
...
&mdash; **def [refs](/recipes/recipe_modules/gitiles/api.py#47)(self, url, step_name='refs', attempts=None):**
...
[DEPS](/recipes/recipe_modules/gitiles/examples/full.py#5): [gitiles](#recipe_modules-gitiles), [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/properties][recipe_engine/recipe_modules/properties]

&mdash; **def [RunSteps](/recipes/recipe_modules/gitiles/examples/full.py#13)(api):**
...
[recipe_engine/recipe_modules/archive]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/b1546529ec629fa8ddf804916c94b6e06c44d693/README.recipes.md#recipe_modules-archive
