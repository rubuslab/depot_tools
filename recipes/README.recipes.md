...
#### **class [Gitiles](/recipes/recipe_modules/gitiles/api.py#15)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

Module for polling a git repository using the Gitiles web interface.

&mdash; **def [canonicalize\_repo\_url](/recipes/recipe_modules/gitiles/api.py#220)(self, repo_url):**

Returns a canonical form of repo_url. If not recognized, returns as is.
    

&mdash; **def [commit\_log](/recipes/recipe_modules/gitiles/api.py#118)(self, url, commit, step_name=None, attempts=None):**
...
&mdash; **def [download\_archive](/recipes/recipe_modules/gitiles/api.py#160)(self, repository_url, destination, revision='refs/heads/master'):**
...
&mdash; **def [download\_file](/recipes/recipe_modules/gitiles/api.py#134)(self, repository_url, file_path, branch='master', step_name=None, attempts=None, \*\*kwargs):**
...
&mdash; **def [log](/recipes/recipe_modules/gitiles/api.py#72)(self, url, ref, limit=0, cursor=None, step_name=None, attempts=None, \*\*kwargs):**
...
&mdash; **def [parse\_repo\_url](/recipes/recipe_modules/gitiles/api.py#209)(self, repo_url):**

Returns (host, project) pair.

Returns (None, None) if repo_url is not recognized.

&mdash; **def [refs](/recipes/recipe_modules/gitiles/api.py#60)(self, url, step_name='refs', attempts=None):**

Returns a list of refs in the remote repository.

&mdash; **def [unparse\_repo\_url](/recipes/recipe_modules/gitiles/api.py#216)(self, host, project):**
