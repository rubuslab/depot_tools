...
class TestGitCl(unittest.TestCase):
  ...
  def getDescriptionForUploadTest(
      self, BatchListOwners, GetCommonAncestorWithUpstream, GetBranch,
      FetchDescription, GetRoot, GetBugPrefix,
    ...
    GetRoot.return_value = 'root'
    GetBranch.return_value = branch
    GetBugPrefix.return_value = 'prefix'
    GetCommonAncestorWithUpstream.return_value = 'upstream'
    FetchDescription.return_value = 'desc'
    BatchListOwners.side_effect = lambda ps: {
