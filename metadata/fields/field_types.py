...
class MetadataField:
    ...
    def is_structured(self):
        """Whether the field represents structured data, such as a list of URLs.

        If true, parser will treat `<unknown_field_name>:` in subsequent lines as a new field, in addition to known field names.
        If false, parser will only recognize known field names, and unknown fields will be merged into the preceding field value.
        """
