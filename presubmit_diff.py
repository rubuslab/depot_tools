...
def fetch_content(host: str, repo: str, ref: str, file: str) -> bytes:
    ...
    If the file does not exist at the commit, returns empty an bytes object.
    ...
    Returns:
        Bytes of the content of the file at the commit, or an empty bytes object
        if the file does not exist at the commit.
    """
