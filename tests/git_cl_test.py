...
class TestGitCl(unittest.TestCase):
    ...
    def setUp(self):
        ...
        mock.patch(
            ...
            lambda *a: self._mocked_call("GetChangeRobotComments", *a),
        ).start()
        mock.patch(
        ...
        mock.patch(
            ...
            lambda h, i, msg=None, labels=None, notify=None, ready=None: (
                self._mocked_call("SetReview", h, i, msg, labels, notify, ready)
            ),
        ).start()
        mock.patch(
        ...
        mock.patch(
            "git_cl.gerrit_util.GceAuthenticator.is_gce", return_value=False
        ).start()
        mock.patch(
        ...
        mock.patch(
            "git_new_branch.create_new_branch", self.mockGit.NewBranch
        ).start()
        mock.patch(
    ...
    def test_LoadCodereviewSettingsFromFile_gerrit(self):
        ...
        self.calls = [
            ...
            (
                (["git", "config", "--unset-all", "rietveld.cpplint-regex"],),
                CERR1,
            ),
            (
                (
    ...
    @mock.patch(
        "git_cl.Changelist._UpdateWithExternalChanges", return_value="newparent"
    )
    ...
    def test_upload_all_precheck_long_chain(
        ...
        *_mocks,
        ...
        self.mockGit.config[
            "branch.upstream2.%s" % git_cl.LAST_UPLOAD_HASH_CONFIG_KEY
        ] = "commit2.3"
        mockIsAncestor.side_effect = [True]

        # Case 3: upstream1's last_upload matches upstream2's base_commit
        self.mockGit.config[
            "branch.upstream1.%s" % git_cl.LAST_UPLOAD_HASH_CONFIG_KEY
        ] = "commit1.5"
    ...
    def test_upload_all_precheck_must_rebase(
        ...
        *_mocks,
        ...
        self.mockGit.config[
            "branch.upstream3.%s" % git_cl.LAST_UPLOAD_HASH_CONFIG_KEY
        ] = "commit3.7"
    ...
    def test_archive_with_format(self):
        ...
        mock.patch(
            "git_cl.get_cl_statuses",
            lambda branches, fine_grained, max_processes: [(
                MockChangelistWithBranchAndIssue("foo", 12),
                "closed",
            )],
        ).start()
    ...
    def test_creds_check_gitcookies_not_configured(self):
        ...
        mock.patch(
            "git_cl._GitCookiesChecker.get_hosts_with_creds",
        ...
        self.calls = [
            ...
            (
                (
                    "ask_for_data",
                    "Press Enter to setup .gitcookies, " "or Ctrl+C to abort",
                ),
                "",
            ),
            (
                ...
                [
                    ...
                    },
                    {
                        ...
                        "message": (
                            ...
                            + "\n"
                            + "/COMMIT_MSG\n"
                            + "  PS2, File comment: https://crrev.com/c/1/2//COMMIT_MSG#\n"
    ...
    def test_git_cl_comments_robot_comments(self):
        ...
        gerrit_util.GetChangeDetail.return_value = {
            ...
            "messages": [
                ...
                },
                {
                    ...
                    "author": {
                        "_account_id": 123,
                        "email": "tricium@serviceaccount.com",
                        "name": "Tricium",
                    },
                    "date": "2017-03-16 20:00:41.000000000",
                    "id": "f5a6c25ecbd3b3b54a43ae418ed97eff046d1234",
                ...
                },
                {
                    ...
                    "date": "2017-03-17 05:30:37.000000000",
                    "tag": "autogenerated:tricium",
                    "id": "f5a6c25ecbd3b3b54a43ae418ed97eff046d4568",
                    "message": "(1 comment)",
                },
        ...
        self.calls = [
            ...
            (
                ...
                ),
                {
                    "codereview.settings": [
                        {
                            "author": {"email": "tricium@serviceaccount.com"},
                            "updated": "2017-03-17 05:30:37.000000000",
                            "robot_run_id": "5565031076855808",
                            "robot_id": "Linter/Category",
                            "tag": "autogenerated:tricium",
                            "patch_set": 2,
                            "side": "REVISION",
                            "message": "Linter warning message text",
                            "line": 32,
                        },
                    ],
                },
        ...
        expected_comments_summary = [
            git_cl._CommentSummary(
                ...
                message=(
                    "(1 comment)\n\ncodereview.settings\n"
                    "  PS2, Line 32: https://x-review.googlesource.com/c/1/2/"
                    "codereview.settings#32\n"
                    "  Linter warning message text\n"
                ),
                sender="tricium@serviceaccount.com",
                autogenerated=True,
                approval=False,
                disapproval=False,
            )
...
class CMDTestCaseBase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        mock.patch(
            "git_cl._call_buildbucket", return_value=self._DEFAULT_RESPONSE
        ).start()
...
class CMDUploadTestCase(CMDTestCaseBase):
    ...
    def setUp(self):
        ...
        mock.patch.dict(
            os.environ, {git_cl.DOGFOOD_STACKED_CHANGES_VAR: "0"}
        ).start()
        self.addCleanup(mock.patch.stopall)
    ...
    def testUploadRetryFailed(self):
        ...
        git_cl._trigger_tryjobs.assert_called_once_with(
...
class MakeRequestsHelperTestCase(unittest.TestCase):
    ...
    def testMakeRequestsHelperPresubmitSetsDryRunProperty(self):
        ...
        self.assertEqual(
            requests[0]["scheduleBuild"]["properties"],
...
class CMDFormatTestCase(unittest.TestCase):
    ...
    def testClangFormatDiffFull(self):
        ...
        return_value = git_cl._RunClangFormatDiff(
            mock_opts, diff_file, self._top_dir, "HEAD"
        )
