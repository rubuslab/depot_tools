...
def CMDsync(parser, args):
  ...
  parser.add_option('--patch-ref', action='append',
                    ...
                    help='Patches the given reference with the format '
                         ...
                         '|ref| will be applied to |dep|, rebased on top of '
                         'what |dep| was synced to, and a soft reset will be '
                         'done. Use --no-rebase-patch-ref and '
                         '--no-reset-patch-ref to disable this behavior. '
                         '|branch| is the target branch against which a patch '
                         'was created, it is used to determine which commits '
                         'from the |ref| actually constitute a patch. If '
                         'not given, we will iterate over all remote branches '
                         'and select one that contains the revision |dep| is '
                         'synced at. '
                         'WARNING: |branch| will be mandatory soon.')
