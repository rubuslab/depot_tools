...
class HooksTest(unittest.TestCase):
    ...
    def populate(self):
        ...
        if os.sep == '\\':
            ...
            # "root_dir\hooks\pre-commit". But because this is a hook running a
            # bash script, it gets interpreted as "root_dirhookspre-commit".
            precommit_path = precommit_path.replace('\\', '\\\\')
