...
""" % (
            ...
            fake_error2,
            fake_error2_items,
            fake_error2_long_text,
            fake_warning,
            fake_warning_items,
            fake_warning_long_text,
            fake_notify,
            fake_notify_items,
            fake_notify_long_text,
        )
...
class CannedChecksUnittest(PresubmitTestsBase):
    ...
    def testCheckChangeHasNoStrayWhitespace(self):
        self.ContentTest(
            lambda x, y, z: presubmit_canned_checks.CheckChangeHasNoStrayWhitespace(
                x, y
            ),
            "Foo",
            None,
...
""",
    ...
    def testCheckLicenseFailCommit(self):
        ...
        self._LicenseCheck(
            text, license_text, True, presubmit.OutputApi.PresubmitPromptWarning
        )
    ...
    def testRunPythonUnitTestsSuccess(self):
        ...
        input_api.unittest = mock.MagicMock(unittest)
        subprocess.Popen().returncode = (
            0  # pylint: disable=no-value-for-parameter
        )
