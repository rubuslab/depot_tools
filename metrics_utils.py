...
APP_URL = 'https://40451-b038d94-ehmaldonado-cit-cli-metrics-dot-cit-cli-metrics.appspot.com'
...
def get_change_notice(version):
  if version == 0:
    ...
    return [
      ...
      'We will authenticate using luci-auth when uploading metrics',
      'if the DEPOT_TOOLS_REPORT_BUILD environment variable is set',
      'to identify the bucket/builder/build.',
