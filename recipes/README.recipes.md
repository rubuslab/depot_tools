...
&mdash; **def [create\_from\_pkg](/recipes/recipe_modules/cipd/api.py#338)(self, pkg_def, refs=None, tags=None):**
...
&mdash; **def [describe](/recipes/recipe_modules/cipd/api.py#445)(self, package_name, version, test_data_refs=None, test_data_tags=None):**

&mdash; **def [ensure](/recipes/recipe_modules/cipd/api.py#360)(self, root, packages):**
...
&mdash; **def [search](/recipes/recipe_modules/cipd/api.py#427)(self, package_name, tag):**

&mdash; **def [set\_ref](/recipes/recipe_modules/cipd/api.py#407)(self, package_name, version, refs):**

&mdash; **def [set\_service\_account\_credentials](/recipes/recipe_modules/cipd/api.py#193)(self, path):**

&mdash; **def [set\_tag](/recipes/recipe_modules/cipd/api.py#387)(self, package_name, version, tags):**
