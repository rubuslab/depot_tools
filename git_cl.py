...
class Changelist(object):
  ...
  def CMDUploadChange(self,
    ...
    try:
      ...
      should_retry = not is_retry and \
          remote_branch == DEFAULT_OLD_BRANCH and \
      ...
      if should_retry:
        ...
        options.title = title
        options.force = True
        return self.CMDUploadChange(options, git_diff_args, custom_cl_base,
                                    change_desc, True)
