...
class Dependency(gclient_utils.WorkItem, DependencySettings):
  ...
  def _postprocess_deps(self, rel_prefix):
  ...
  def _deps_to_objects(self, deps):
    # type: (Mapping[str, str], bool, Mapping[str, str])
    #     -> Sequence[Dependency]
  ...
  def ParseDepsFile(self):
    ...
    deps_to_add = self._deps_to_objects(
        self._postprocess_deps(deps, rel_prefix))
...
class CipdDependency(Dependency):
  ...
  def ParseDepsFile(self, _patch_refs):
