...
class ChangeDescription(object):
  ...
  def update_with_git_number_footers(self, parent_hash, parent_msg, dest_ref):
    ...
    Consult go/gnumbd OR public doc
    https://docs.google.com/document/d/1i0pNHKagCsGxOIT7H44kk2mnTEjV9BdfgBjVleFhBr0/edit
    for more details.
    """
    ...
    # from git_footers perspective. This also what Gnumbd did.
    cp_line = None
    ...
    if parent_position[0] == dest_ref:
      ...
      lineage.append('%s-%s@{#%d}' % (parent_hash, parent_position[0],
  ...
  try:
    ...
    if cmd == 'land':
      ...
      if ShouldGenerateGitNumberFooters():
        # TODO(tandrii): run git fetch in a loop + autorebase?
        ...
        # TODO(tandrii): what about pending? Worst case we get double footers in
        # Gnumbd?
