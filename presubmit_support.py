...
def _parse_change(parser, options):
    ...
    if options.files:
        ...
        change_files = _diff_to_change_files(options.diff_file)
    else:
...
def _diff_to_change_files(diff_file):
    """Converts a git diff to a list of change files.
