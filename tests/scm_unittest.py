...
class GitWrapperTestCase(BaseSCMTestCase):
  ...
  def testRefToRemoteRef(self):
    remote = 'origin'
    prefix = 'refs/remotes/dt-origin/'
    refs = {
        # This shouldn't be any different from the NoRemote() version.
        'refs/branch-heads/1234': prefix + 'branch-heads/1234',
        # local refs for upstream branch
        'refs/remotes/origin/foobar': 'refs/remotes/origin/foobar',
        'origin/foobar': 'refs/remotes/dt-origin/heads/foobar',
        # upstream ref for branch
        'refs/heads/foobar': prefix + 'heads/foobar',
        # could be either local or upstream ref, assumed to refer to
        # upstream, but probably don't want to encourage refs like this.
        'heads/foobar': prefix + 'heads/foobar',
        # underspecified, probably intended to refer to a local branch
        'foobar': None,
        # Tags and other refs.
        'refs/tags/abcd': 'refs/tags/abcd',
        'refs/changes/34/1234': 'refs/remotes/dt-origin/changes/34/1234',
        }
  ...
  def testRemoteRefToRef(self):
    ...
    prefix = 'refs/remotes/dt-origin/'
    refs = {
      prefix + 'heads/foobar': 'refs/heads/foobar',
      prefix + 'changes/34/1234': 'refs/changes/34/1234',
      prefix + 'branch-heads/1234': 'refs/branch-heads/1234',
      prefix + 'tags/abcd': 'refs/tags/abcd',
      'refs/tags/abcd': 'refs/tags/abcd',
      'refs/remotes/origin/foobar': None,
      'refs/remotes/branch-heads/1234': None,
    }
    for k, v in refs.items():
