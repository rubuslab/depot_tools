...
&mdash; **def [cat\_file\_at\_commit](/recipes/recipe_modules/git/api.py#44)(self, file_path, commit_hash, remote_name=None, \*\*kwargs):**
...
&mdash; **def [count\_objects](/recipes/recipe_modules/git/api.py#52)(self, previous_result=None, can_fail_build=False, \*\*kwargs):**
...
&mdash; **def [fetch\_tags](/recipes/recipe_modules/git/api.py#38)(self, remote_name=None, \*\*kwargs):**
