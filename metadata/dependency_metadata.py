...
class DependencyMetadata:
    ...
    def _assess_required_fields(self) -> Set[field_types.MetadataField]:
        ...
        if version_value is None or metadata.fields.custom.version.is_unknown(
            version_value
        ):
    ...
    def validate(
        self, source_file_dir: str, repo_root_dir: str
        ...
        repeated_field_info = [
            ...
            for field, count in self._occurrences.items()
            if count > 1
        ]
