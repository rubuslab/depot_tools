...
sq_str = quote (~(quote | eol) sqchar)*:cs quote           -> join('', cs),
...
dq_str = dquote (~(dquote | eol) dqchar)*:cs dquote        -> join('', cs),
