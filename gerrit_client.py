...
def CMDrawapi(parser, args):
  """Call an arbitrary Gerrit API specified by --path."""
  parser.add_option('--path', dest='path', help='HTTP path for the API')
  parser.add_option('--method', dest='method', help='HTTP method for the API')
