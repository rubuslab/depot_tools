...
class Change(object):
    ...
    def AffectedFiles(self, include_deletes=True, file_filter=None):
        ...
        """
        files = [
            af for af in self._affected_files if af.LocalPath() not in
            scm.GIT.ListSubmodules(self.RepositoryRoot())
        ]
    ...
    def AffectedSubmodules(self):
        ...
        return [
            ...
            if af.LocalPath() in scm.GIT.ListSubmodules(self.RepositoryRoot())
        ]
