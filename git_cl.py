...
class _GerritChangelistImpl(_ChangelistCodereviewBase):
  ...
  def CMDPatchWithParsedIssue(self, parsed_issue_arg, reject, nocommit,
    ...
    if clean != 0:
      ...
      self.SetIssue(self.GetIssue())
      self.SetPatchset(patchset)
      fetched_hash = RunGit(['rev-parse', 'FETCH_HEAD'])
      self._GitSetBranchConfigValue('last-upload-hash', fetched_hash.strip())
      self._GitSetBranchConfigValue('gerritsquashhash', fetched_hash.strip())
