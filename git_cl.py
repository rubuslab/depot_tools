...
# This contains the commit hash of the new squashed commit.
...
class Changelist(object):
  ...
  def CMDUpload(self, options, git_diff_args, orig_args):
    ...
    if not ret:
      last_hash = scm.GIT.ResolveCommit(settings.GetRoot(), 'HEAD')
      print('setting last_hash', last_hash)
      self._GitSetBranchConfigValue(LAST_UPLOAD_HASH_CONFIG_KEY, last_hash)
  ...
  def _CMDUploadChange(self, options, git_diff_args, custom_cl_base,
    ...
    if options.squash:
      ...
      print('setting ref_to_push', ref_to_push)
