...
[1 processes, 23/23 @ 0.9/s : 26.280s ] LINK(DLL) base.dll base.dll.lib
    Longest build steps:
           0.9 weighted s to build obj/base/base_jumbo_17.obj (5.0 s elapsed time)
           1.0 weighted s to build obj/base/base_jumbo_31.obj (13.1 s elapsed time)
           1.2 weighted s to build obj/base/base_jumbo_4.obj (14.7 s elapsed time)
           1.3 weighted s to build obj/base/base_jumbo_32.obj (15.0 s elapsed time)
           1.6 weighted s to build obj/base/base_jumbo_26.obj (17.1 s elapsed time)
           1.7 weighted s to build base.dll, base.dll.lib (1.7 s elapsed time)
           1.7 weighted s to build obj/base/base_jumbo_11.obj (15.9 s elapsed time)
           1.9 weighted s to build obj/base/base_jumbo_12.obj (18.5 s elapsed time)
           3.6 weighted s to build obj/base/base_jumbo_34.obj (20.1 s elapsed time)
           4.3 weighted s to build obj/base/base_jumbo_33.obj (22.3 s elapsed time)
    Time by build-step type:
           0.1 s weighted time to generate 1 .c files (0.1 s elapsed time sum)
           0.1 s weighted time to generate 1 .stamp files (0.1 s elapsed time sum)
           0.2 s weighted time to generate 1 .h files (0.2 s elapsed time sum)
           1.7 s weighted time to generate 1 PEFile files (1.7 s elapsed time sum)
          24.3 s weighted time to generate 19 .obj files (233.4 s elapsed time sum)
    26.3 s weighted time (235.5 s elapsed time sum, 9.0x parallelism)
