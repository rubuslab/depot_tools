...
def CMDpresubmit(parser, args):
  ...
  if options.all:
    ...
    change = presubmit_support.GitChange(
        base_change.name, base_change.description, base_change.local_root,
        base_change.AllFiles(), base_change.issue, base_change.patchset,
        base_change.author, base_change.upstream)
  else:
