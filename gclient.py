...
class Dependency(gclient_utils.WorkItem, DependencySettings):
  ...
  def MergeWithOsDeps(self, deps, deps_os, target_os_list):
...
class Flattener(object):
  ...
  def _flatten(self, pin_all_deps=False):
    ...
    if pin_all_deps:
      ...
      for dep_os, os_deps in self._deps_os.iteritems():
        for name, dep in os_deps.iteritems():
