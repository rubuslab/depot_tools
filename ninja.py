...
def fallbackToLegacyNinja(ninja_args):
  print('depot_tools/ninja.py: Fallback to a deprecated legacy ninja binary. '
        'Please note that this binary will be removed soon.', file=sys.stderr)
