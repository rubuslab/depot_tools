    ...
    return ConfigGroup(
        solutions=ConfigList(
            lambda: ConfigGroup(
                ...
                managed=Single(
                    bool, empty_val=True, required=False, hidden=False
                ),
        ...
        revisions=Dict(
            value_type=(str, gclient_api.RevisionResolver), hidden=True
        ),
...
def chrome_golo(c):  # pragma: no cover
    ...
    s.name = "chrome_golo"
    s.url = (
        "https://chrome-internal.googlesource.com/chrome-golo/chrome-golo.git"
    )
...
def infra_internal(c):  # pragma: no cover
    ...
    soln.url = (
        "https://chrome-internal.googlesource.com/infra/infra_internal.git"
    )
    c.got_revision_mapping["infra_internal"] = "got_revision"
...
def gerrit_test_cq_normal(c):
    ...
    soln.url = (
        "https://chromium.googlesource.com/playground/gerrit-cq/normal.git"
    )
...
def gerrit_plugins_chromium_behavior(c):
    ...
    s.url = ChromiumGitURL(
        c, "infra", "gerrit-plugins", "chromium-behavior.git"
    )
