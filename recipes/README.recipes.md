...
#### **class [GitApi](/recipes/recipe_modules/git/api.py#13)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

&mdash; **def [\_\_call\_\_](/recipes/recipe_modules/git/api.py#16)(self, \*args, \*\*kwargs):**

Returns a git command step.

&mdash; **def [bundle\_create](/recipes/recipe_modules/git/api.py#375)(self, bundle_path, rev_list_args=None, \*\*kwargs):**
...
&mdash; **def [config\_get](/recipes/recipe_modules/git/api.py#344)(self, prop_name, \*\*kwargs):**
...
&mdash; **def [count\_objects](/recipes/recipe_modules/git/api.py#44)(self, previous_result=None, raise_on_failure=False, \*\*kwargs):**
...
&mdash; **def [fetch\_tags](/recipes/recipe_modules/git/api.py#30)(self, remote_name=None, \*\*kwargs):**
...
&mdash; **def [new\_branch](/recipes/recipe_modules/git/api.py#388)(self, branch, name=None, upstream=None, upstream_current=False, \*\*kwargs):**
...
&mdash; **def [number](/recipes/recipe_modules/git/api.py#419)(self, commitrefs=None, test_values=None):**
...
&mdash; **def [canonicalize\_repo\_url](/recipes/recipe_modules/gitiles/api.py#229)(self, repo_url):**
...
&mdash; **def [download\_archive](/recipes/recipe_modules/gitiles/api.py#169)(self, repository_url, destination, revision='refs/heads/main'):**
...
&mdash; **def [parse\_repo\_url](/recipes/recipe_modules/gitiles/api.py#218)(self, repo_url):**
...
&mdash; **def [unparse\_repo\_url](/recipes/recipe_modules/gitiles/api.py#225)(self, host, project):**
