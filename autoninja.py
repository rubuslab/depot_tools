...
def main(args):
  ...
  # builds. However, it is not as fast as doing a "normal" non-goma build because
  # an extra process is created for each compile step. Checking this environment
  # variable ensures that autoninja uses an appropriate -j value in this
  # situation.
