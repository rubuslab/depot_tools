...
PROPERTIES = {
  ...
  'ver_file': Property(default=None, kind=str),
}

def RunSteps(api, use_pkg, pkg_files, pkg_dirs, ver_file):
  ...
  if use_pkg:
    ...
    pkg = api.cipd.PackageDefinition('infra/fake-package', root)
