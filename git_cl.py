...
class Changelist(object):
  ...
  def __init__(self, branchref=None, issue=None, codereview_host=None, commit_date=None):
...
class ChangeDescription(object):
  ...
  def prompt(self):
    ...
    def has_issue(l): return bug_regexp.match(l) or fixed_regexp.match(l)
