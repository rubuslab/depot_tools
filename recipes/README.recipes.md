...
Args:
  ...
  * accept_input_gerrit_changes: should get the patchset from
    buildbucket.build.input.gerrit_changes. If True, assert the size
    of buildbucket.build.input.gerrit_changes to be one, because bot_update
