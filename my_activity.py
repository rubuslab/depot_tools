...
class MyActivity(object):
  ...
  def monorail_get_auth_http(self):
    ...
    # Manually use a large timeout; for some users who have a long
    # history on the issue tracker, whatever the default timeout is is
    # reached.
    return authenticator.authorize(httplib2.Http(timeout=10000))
