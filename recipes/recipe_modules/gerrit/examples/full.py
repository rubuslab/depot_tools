...
def RunSteps(api):
    ...
    data = api.gerrit.create_gerrit_branch(
        host, project, branch, commit, allow_existent_branch=True
    )
    ...
    api.gerrit.get_change_description(host, change=123, patchset=1)
