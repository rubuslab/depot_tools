...
def main(out_dir):
    ...
    if not os.path.exists(gn_args_path):
        ...
        return 1
    if not autoninja.read_gn_args(gn_args_path).use_remoteexec:
        print(
    ...
    # Try execute 'echo Hello World' remotely, this ensures that authentication
    # and authorization with the remote build backend is validated
