...
class Changelist(object):
  ...
  def RunHook(self, committing, may_prompt, verbose, parallel, upstream,
    ...
    if (('@google.com' in email) or ('@chromium.org' in email)) and \
      ...
      resultdb = True
      #NOTE: this is just a dummy for now. In any change we merge, we need a way
      #to identify the realm specific to the project (not just chromium:public)
      realm = 'chromium:public'# TODO (crbug.com/1113463): store realm somewhere
