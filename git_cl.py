...
class Changelist(object):
    ...
    def _GetDescriptionForUpload(self, options: optparse.Values,
        ...
        if options.new_description:
            description = options.new_description
            if description == '-':
...
def CMDupload(parser, args):
    ...
    parser.add_option('--message',
                      '-m',
                      dest='message',
                      help='DEPRECATED: use --new-description and/or --title '
                      'instead. message for patchset')
    parser.add_option('-b',
                      '--bug',
    ...
    parser.add_option('--message-file',
                      dest='message_file',
                      help='DEPRECATED: use `--new-description -` and pipe the'
                      'file to stdin instead. File which contains message for '
                      'patchset')
    ...
    parser.add_option('--edit-description',
                      ...
                      'with --force or --new-description. It is a noop when '
                      '--no-squash is set or a new commit is created.')
    parser.add_option('--new-description',
    ...
    if options.edit_description and options.new_description:
        parser.error('Only one of --new-description and --edit-description '
                     'allowed')

    if options.message and options.new_description:
        parser.error('Only one of --new-description and --message allowed')

    if options.new_description and options.new_description == '-':
        options.force = True
    ...
    if options.message_file:
        ...
        if options.new_description:
            parser.error('Only one of --new-description and --message-file '
                         'allowed.')
