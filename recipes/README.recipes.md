...
#### **class [CIPDApi](/recipes/recipe_modules/cipd/api.py#159)([RecipeApi][recipe_engine/wkt/RecipeApi]):**
...
&mdash; **def [build](/recipes/recipe_modules/cipd/api.py#232)(self, input_dir, output_package, package_name, install_mode=None):**
...
&mdash; **def [create\_from\_pkg](/recipes/recipe_modules/cipd/api.py#328)(self, pkg_def, refs=None, tags=None):**
...
&mdash; **def [create\_from\_yaml](/recipes/recipe_modules/cipd/api.py#308)(self, pkg_def, refs=None, tags=None):**
...
&emsp; **@property**<br>&mdash; **def [default\_bot\_service\_account\_credentials](/recipes/recipe_modules/cipd/api.py#196)(self):**

&mdash; **def [describe](/recipes/recipe_modules/cipd/api.py#435)(self, package_name, version, test_data_refs=None, test_data_tags=None):**

&mdash; **def [ensure](/recipes/recipe_modules/cipd/api.py#350)(self, root, packages):**
...
&emsp; **@property**<br>&mdash; **def [executable](/recipes/recipe_modules/cipd/api.py#192)(self):**

&mdash; **def [initialize](/recipes/recipe_modules/cipd/api.py#186)(self):**

&mdash; **def [platform\_suffix](/recipes/recipe_modules/cipd/api.py#205)(self, name=None, arch=None, bits=None):**
...
&mdash; **def [register](/recipes/recipe_modules/cipd/api.py#260)(self, package_name, package_path, refs=None, tags=None):**

&mdash; **def [search](/recipes/recipe_modules/cipd/api.py#417)(self, package_name, tag):**

&mdash; **def [set\_ref](/recipes/recipe_modules/cipd/api.py#397)(self, package_name, version, refs):**

&mdash; **def [set\_service\_account\_credentials](/recipes/recipe_modules/cipd/api.py#189)(self, path):**

&mdash; **def [set\_tag](/recipes/recipe_modules/cipd/api.py#377)(self, package_name, version, tags):**
