...
class TestGitCl(unittest.TestCase):
  ...
  def test_upload_all_squashed(self, mockSquashedCommit, mockUploadAllPrecheck,
    ...
    # Asserts
    self.maxDiff = None
    logging.error(mockSquashedCommit.mock_calls[0])
    logging.error('chicken')
  ...
  def test_upload_all_precheck_long_chain(
    ...
    branches = [
        'current', 'upstream3', 'blank2', 'upstream2', 'blank1', 'upstream1',
        'origin/main'
    ]
    ...
    mockRunGit.side_effect = [
        'commit4', 'commit3', 'commit2', 'commit1.5', 'commit1', 'commit0.5'
    ]
    mockRunGitSilent.side_effect = ['diff', 'diff', None, 'diff', None, 'diff']
