...
&mdash; **def [\_\_call\_\_](/recipes/recipe_modules/gsutil/api.py#22)(self, cmd, name=None, use_retry_wrapper=True, version=None, parallel_upload=False, multithreaded=False, infra_step=True, \*\*kwargs):**
...
&mdash; **def [cat](/recipes/recipe_modules/gsutil/api.py#116)(self, url, args=None, \*\*kwargs):**

&mdash; **def [copy](/recipes/recipe_modules/gsutil/api.py#130)(self, source_bucket, source, dest_bucket, dest, args=None, link_name='gsutil.copy', metadata=None, unauthenticated_url=False, \*\*kwargs):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [disable\_multiprocessing\_on\_mac](/recipes/recipe_modules/gsutil/api.py#170)(self):**
...
&mdash; **def [download](/recipes/recipe_modules/gsutil/api.py#102)(self, bucket, source, dest, args=None, \*\*kwargs):**

&mdash; **def [download\_url](/recipes/recipe_modules/gsutil/api.py#109)(self, url, dest, args=None, \*\*kwargs):**

&emsp; **@property**<br>&mdash; **def [gsutil\_py\_path](/recipes/recipe_modules/gsutil/api.py#18)(self):**

&mdash; **def [list](/recipes/recipe_modules/gsutil/api.py#149)(self, url, args=None, \*\*kwargs):**

&mdash; **def [remove\_url](/recipes/recipe_modules/gsutil/api.py#163)(self, url, args=None, \*\*kwargs):**

&mdash; **def [signurl](/recipes/recipe_modules/gsutil/api.py#156)(self, private_key_file, bucket, dest, args=None, \*\*kwargs):**

&mdash; **def [stat](/recipes/recipe_modules/gsutil/api.py#123)(self, url, args=None, \*\*kwargs):**

&mdash; **def [upload](/recipes/recipe_modules/gsutil/api.py#85)(self, source, bucket, dest, args=None, link_name='gsutil.upload', metadata=None, unauthenticated_url=False, \*\*kwargs):**
...
&mdash; **def [RunSteps](/recipes/recipe_modules/gsutil/examples/custom_boto.py#16)(api):**
