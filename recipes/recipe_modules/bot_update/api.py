      ...
      if step_result and step_result.json.output:
        ...
        if set_output_commit and git_checkout:
          ...
          if not output_commit.ref.startswith('refs/'):
            ...
            # input commit.
            # If this assertion fails, either revisions[main_repo_path]
            # the caller should not pass set_output_commit
            # and call api.buildbucket.set_output_gitiles_commit themselves.
            assert (
