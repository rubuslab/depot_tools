...
def _GetDiffLineRanges(files, upstream_commit):
  """ Get the changed line ranges between upstream_commit

  Parses git diff output to returns a dict that maps a file name
