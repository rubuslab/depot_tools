...
class SSOAuthenticator(Authenticator):
    ...
    Googler machines are configured so that all *.googlesource.com
    domains are routed instead to *.git.corp.google.com via a secure
    tunnel which is integrated with SSO authentication.
