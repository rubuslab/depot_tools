...
class BotUpdateApi(recipe_api.RecipeApi):
  ...
  def ensure_checkout(self,
                      ...
                      should_skip_input_changes=False,
    ...
    Args:
      ...
      * should_skip_input_changes: Skip checking the size of input changes.
        bot_update module ONLY supports one CL. If users do not explicitly
        assign it via tryserver.reinitialize(), bot_update asserts
        `buildbucket.build.input.gerrit_changes` should be 1.
    ...
    if not should_skip_input_changes:
