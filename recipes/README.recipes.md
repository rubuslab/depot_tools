...
&mdash; **def [move\_changes](/recipes/recipe_modules/gerrit/api.py#244)(self, host, project, from_branch, to_branch, step_test_data=None):**
...
&mdash; **def [update\_files](/recipes/recipe_modules/gerrit/api.py#268)(self, host, project, branch, new_contents_by_file_path, commit_msg, params=frozenset(['status=NEW']), submit=False):**
