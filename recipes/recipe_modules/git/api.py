...
class GitApi(recipe_api.RecipeApi):
  ...
  def number(self, commitrefs=None, test_values=None):
    ...
    Args:
      ...
      * test_values (list[int]): A list of numbers to use as the return
    ...
    Returns:
    A list of the generation numbers of the commits. If non-empty
    commitrefs was provided, the order of the returned numbers will
    correspond to the order of the provided commitrefs.
    """
    ...
    return [int(l.strip()) for l in step_result.stdout.strip().splitlines()]
