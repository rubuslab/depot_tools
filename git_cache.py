...
class Mirror(object):
    ...
    def config(self, reset_fetch_config=False):
        ...
        # of "Resolving deltas".
        scm.GIT.SetConfig(os.getcwd(), 'core.deltaBaseCacheLimit',
    ...
    """
        if not self.exists():
            return
        try:
            config_fetchspecs = scm.GIT.GetConfigList(self.mirror_path,
                                                      'remote.origin.fetch')
    ...
    def _fetch(self,
        ...
        fetch_specs = scm.GIT.GetConfigList(self.mirror_path,
                                            'remote.origin.fetch')
