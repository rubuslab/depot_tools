...
&mdash; **def [bundle\_create](/recipes/recipe_modules/git/api.py#393)(self, bundle_path, rev_list_args=None, \*\*kwargs):**
...
&mdash; **def [config\_get](/recipes/recipe_modules/git/api.py#362)(self, prop_name, \*\*kwargs):**
...
&mdash; **def [get\_timestamp](/recipes/recipe_modules/git/api.py#333)(self, commit='HEAD', test_data=None, \*\*kwargs):**

Find and return the timestamp of the given commit.

&mdash; **def [new\_branch](/recipes/recipe_modules/git/api.py#406)(self, branch, name=None, upstream=None, upstream_current=False, \*\*kwargs):**
...
&mdash; **def [rebase](/recipes/recipe_modules/git/api.py#342)(self, name_prefix, branch, dir_path, remote_name=None, \*\*kwargs):**
