...
#### **class [GitApi](/recipes/recipe_modules/git/api.py#17)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

&mdash; **def [\_\_call\_\_](/recipes/recipe_modules/git/api.py#20)(self, \*args, \*\*kwargs):**

Returns a git command step.

&mdash; **def [bundle\_create](/recipes/recipe_modules/git/api.py#387)(self, bundle_path, rev_list_args=None, \*\*kwargs):**
...
&mdash; **def [count\_objects](/recipes/recipe_modules/git/api.py#55)(self, previous_result=None, can_fail_build=False, \*\*kwargs):**
...
&mdash; **def [fetch\_tags](/recipes/recipe_modules/git/api.py#41)(self, remote_name=None, \*\*kwargs):**

Fetches all tags from the remote.

&mdash; **def [get\_remote\_url](/recipes/recipe_modules/git/api.py#375)(self, remote_name=None, \*\*kwargs):**
...
&mdash; **def [new\_branch](/recipes/recipe_modules/git/api.py#400)(self, branch, name=None, upstream=None, \*\*kwargs):**
