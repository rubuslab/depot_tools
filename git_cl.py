...
class _GerritChangelistImpl(_ChangelistCodereviewBase):
  ...
  def _ComputeParent(self, remote, upstream_branch, custom_cl_base, force,
    ...
    if custom_cl_base:
      ...
      if code == 1:
        print('WARNING: Specified base of this CL `%s` doesn\'t seem to belong '
              'target remote branch %s\n'
              '  If you proceed with upload, more than 1 CL may be created by '
              'Gerrit as a result, in turn confusing or crashing git cl.\b'
              'If you are 100%% certain specified base `%s` has already been '
