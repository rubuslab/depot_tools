...
def CMDupload(parser, args):
  ...
  """
    ...
    parser.add_option(
        '--preserve-tryjobs',
        action='store_true',
        help='instruct the CQ to not cancel tryjobs for this '
        'patchset if new patchsets are uploaded after this one. '
        'Note this only protects the tryjobs of the patchset currently '
        'being uploaded. Tryjobs of previous patchsets uploaded without '
        'this flag are NOT protected from cancellation.')
    parser.add_option(
        '--dependencies',
        action='store_true',
