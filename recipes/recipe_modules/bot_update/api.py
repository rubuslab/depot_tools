    ...
    try:
      ...
      if step_result and step_result.json.output:
        ...
        if set_output_commit:
          # Today got_revision describes the output commit, the same commit that
          # Build.output.gitiles_commit describes.
          ...
          if got_revision_cp:
            ...
            assert out_commit.id == in_commit.id, (in_commit, out_commit)
            assert in_commit.ref
