...
class Mirror(object):
  ...
  @staticmethod
  def GetMostRecentCacheDirectory(ls_out):
    """Returns the most recent cache directory."""
  ...
  def bootstrap_repo(self, directory):
    ...
    latest_dir = self.GetMostRecentCacheDirectory(ls_out)
  ...
  def update_bootstrap(self, prune=False):
    ...
    prev_dest_prefix = self.GetMostRecentCacheDirectory(ls_out)
