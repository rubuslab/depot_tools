...
class BotUpdateApi(recipe_api.RecipeApi):
  ...
  def ensure_checkout(self,
    ...
    Args:
      ...
      no_fetch_checkout_tags: When true, the root git repo being checked out will
        not fetch any tags referenced from the references being fetched. When
    ...
    if no_fetch_checkout_tags:
      cmd.append('--no_fetch_checkout_tags')
  ...
  def deapply_patch(self, bot_update_step):
    ...
    # TODO(crbug.com/1019824): Pass |no_fetch_checkout_tags=True| here to
    # prevent fetching 10k+ tags for chromium. This operation shouldn't
    # need tags, it is removing a previously applied patch.
