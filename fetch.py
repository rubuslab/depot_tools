...
def handle_args(argv):
  ...
  parser = argparse.ArgumentParser(
    ...
    description='''This script can be used to download the Chromium sources. See
...
for full usage instructions.''',
  ...
  parser.add_argument('config', type=str, help="project to fetch. eg: chromium")
  parser.add_argument('props', metavar='props', type=str, nargs='*', default=[])

  args = parser.parse_args(argv[1:])
  config = args.pop('config')
  props = args.pop('props')

  return (args, config, props)
