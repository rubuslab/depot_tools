...
class NinjaReclientTest(trial_dir.TestCase):
    ...
    def test_ninja_reclient_collect_metrics_cache_missing(
        ...
        self.assertEqual(
            ...
            "source=developer,tool=ninja_reclient,credscache=missing")
...
expiry:  {
  seconds:  %d
        ...
        self.assertEqual(
            os.environ.get('RBE_metrics_labels'),
            "source=developer,tool=ninja_reclient,credscache=valid")
        self.assertEqual(os.environ.get('RBE_metrics_prefix'),
                         "go.chromium.org")
...
expiry:  {
  seconds:  %d
        ...
        self.assertEqual(
            os.environ.get('RBE_metrics_labels'),
            "source=developer,tool=ninja_reclient,credscache=expired")
        self.assertEqual(os.environ.get('RBE_metrics_prefix'),
                         "go.chromium.org")
