...
class GerritChangesTest(fake_repos.FakeReposTestBase):
  ...
  def testCheckoutOriginFeature(self):
    ...
    # Sync to origin's refs/heads/feature
  ...
  def testCheckoutOriginFeatureOnOldRevision(self):
    ...
    # Sync to origin's refs/heads/feature on an old revision
    ...
    # origin's master branch and the change) but on top of 7 (which is the
    # merge base between origin's feature branch and the change).
  ...
  def testCheckoutOriginFeaturePatchBranch(self):
    ...
    # Apply refs/changes/34/1234/1, created for origin's master branch on top of
    # origin's feature branch.
    ...
    # part of origin's feature branch.
