...
**[Recipes](#Recipes)**
  ...
  * [gerrit:tests/create_branch_fail_with_409_error](#recipes-gerrit_tests_create_branch_fail_with_409_error) (Python3 ✅)
...
&mdash; **def [abandon\_change](/recipes/recipe_modules/gerrit/api.py#277)(self, host, change, message=None, name=None, step_test_data=None):**
...
&mdash; **def [create\_gerrit\_tag](/recipes/recipe_modules/gerrit/api.py#99)(self, host, project, tag, commit, \*\*kwargs):**
...
&mdash; **def [get\_change\_description](/recipes/recipe_modules/gerrit/api.py#138)(self, host, change, patchset, timeout=None, step_test_data=None):**
...
&mdash; **def [get\_changes](/recipes/recipe_modules/gerrit/api.py#198)(self, host, query_params, start=None, limit=None, o_params=None, step_test_data=None, \*\*kwargs):**
...
&mdash; **def [get\_gerrit\_branch](/recipes/recipe_modules/gerrit/api.py#120)(self, host, project, branch, \*\*kwargs):**
...
&mdash; **def [get\_related\_changes](/recipes/recipe_modules/gerrit/api.py#241)(self, host, change, revision='current', step_test_data=None):**
...
&mdash; **def [get\_revision\_info](/recipes/recipe_modules/gerrit/api.py#157)(self, host, change, patchset, timeout=None, step_test_data=None):**
...
&mdash; **def [move\_changes](/recipes/recipe_modules/gerrit/api.py#315)(self, host, project, from_branch, to_branch, step_test_data=None):**

&mdash; **def [set\_change\_label](/recipes/recipe_modules/gerrit/api.py#297)(self, host, change, label_name, label_value, name=None, step_test_data=None):**

&mdash; **def [update\_files](/recipes/recipe_modules/gerrit/api.py#339)(self, host, project, branch, new_contents_by_file_path, commit_msg, params=frozenset(['status=NEW']), cc_list=frozenset([]), submit=False, submit_later=False, step_test_data_create_change=None, step_test_data_submit_change=None):**
...
### *recipes* / [gerrit:tests/create\_branch\_fail\_with\_409\_error](/recipes/recipe_modules/gerrit/tests/create_branch_fail_with_409_error.py)

[DEPS](/recipes/recipe_modules/gerrit/tests/create_branch_fail_with_409_error.py#7): [gerrit](#recipe_modules-gerrit), [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/step][recipe_engine/recipe_modules/step]

PYTHON_VERSION_COMPATIBILITY: PY3

&mdash; **def [RunSteps](/recipes/recipe_modules/gerrit/tests/create_branch_fail_with_409_error.py#15)(api):**
