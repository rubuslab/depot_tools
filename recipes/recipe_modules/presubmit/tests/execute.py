...
def GenTests(api):
    ...
    yield (
        api.test("failure-long-message", status="FAILURE")
        + api.runtime(is_experimental=False)
        + api.buildbucket.try_build(project="infra")
        + api.step_data(
            "presubmit",
    ...
    yield (
        api.test("infra-failure", status="INFRA_FAILURE")
        + api.runtime(is_experimental=False)
        + api.buildbucket.try_build(project="infra")
        + api.step_data(
            "presubmit",
    ...
    yield (
        api.test("failure-no-json", status="INFRA_FAILURE")
        + api.runtime(is_experimental=False)
        + api.buildbucket.try_build(project="infra")
    ...
    yield (
        api.test("infra-failure-no-json", status="INFRA_FAILURE")
        + api.runtime(is_experimental=False)
        + api.buildbucket.try_build(project="infra")
