...
&mdash; **def [build](/recipes/recipe_modules/cipd/api.py#220)(self, input_dir, output_package, package_name, install_mode=None):**
...
&mdash; **def [create\_from\_pkg](/recipes/recipe_modules/cipd/api.py#316)(self, pkg_def, refs=None, tags=None):**
...
&mdash; **def [create\_from\_yaml](/recipes/recipe_modules/cipd/api.py#296)(self, pkg_def, refs=None, tags=None):**
...
&mdash; **def [describe](/recipes/recipe_modules/cipd/api.py#423)(self, package_name, version, test_data_refs=None, test_data_tags=None):**

&mdash; **def [ensure](/recipes/recipe_modules/cipd/api.py#338)(self, root, packages):**
...
&mdash; **def [register](/recipes/recipe_modules/cipd/api.py#248)(self, package_name, package_path, refs=None, tags=None):**

&mdash; **def [search](/recipes/recipe_modules/cipd/api.py#405)(self, package_name, tag):**

&mdash; **def [set\_ref](/recipes/recipe_modules/cipd/api.py#385)(self, package_name, version, refs):**

&mdash; **def [set\_service\_account\_credentials](/recipes/recipe_modules/cipd/api.py#178)(self, path):**

&mdash; **def [set\_tag](/recipes/recipe_modules/cipd/api.py#365)(self, package_name, version, tags):**
