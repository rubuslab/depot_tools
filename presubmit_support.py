...
# We modify commands which invoke 'python' to invoke them with vpython instead.
# We do this so that scripts inside of repos have the opportunity to provide and
# rely on their own `.vpython` files.
PYTHON = 'python'
