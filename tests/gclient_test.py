...
class GclientTest(trial_dir.TestCase):
  ...
  def testFindInDependenciesByURL(self):
    write(
        '.gclient',
        'solutions = [\n'
    ...
    self.assertEqual(
        ...
        foo_sol.FindInDependencies('https://example.com/foo.git',
                                   ['https://example.com/foo.git', 'foo']))

  def testFindInDependenciesByURLNoGit(self):
    write(
        '.gclient',
        'solutions = [\n'
        '  { "name": "foo", "url": "https://example.com/foo.git",\n'
  ...
  def testFindInDependenciesByName(self):
    write(
        '.gclient',
        'solutions = [\n'
    ...
    self.assertEqual(
        'foo',
        foo_sol.FindInDependencies('https://example.com/foo.git', ['foo']))
