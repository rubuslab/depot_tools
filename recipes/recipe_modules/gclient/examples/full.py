...
def RunSteps(api):
  ...
  bl_cfg.patch_projects['my/stuff'] = ('src/third_party/my/stuff', 'HEAD')
  bl_cfg.revisions['src/third_party/my/stuff'] = 'HEAD'

  api.gclient.update_revision_destination_branch('my/stuff', 'feature', bl_cfg)
