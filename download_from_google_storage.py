...
def download_from_google_storage(
  ...
  # Call this once to ensure it exists. Only needs to be done if we'll process
  # input data in parallel, which can lead to a race in gsutil's self update on
  # the first call. Note, this causes a network call. Any fast bailout should be
