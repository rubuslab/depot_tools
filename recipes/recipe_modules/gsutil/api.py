...
class GSUtilApi(recipe_api.RecipeApi):
  ...
  def disable_multiprocessing_on_mac(self):
    """This will temporarily disable gsutil's use of multi-processing on mac.

    Due to a combination of https://issuetracker.google.com/233248012 and
    https://bugs.python.org/issue33725, using gsutil to download sufficiently
    large files on MacOS has been seen to hang indefinitely, and disabling
    multi-processing avoids this hang.
